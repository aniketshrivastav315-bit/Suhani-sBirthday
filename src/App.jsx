    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Miss Cutiee</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Suhani's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Dekho kuch Ganda ho to sorry lekin mujhe itna hi aata hai😭😭 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours (Friend beta friend) — [Mr. Aniket😎😎😎] 💖</h2>
          <p className="final-subtitle">Chlo Kaafi hai... Mujhe itna hi aata hai bbyee ✨</p>
        </section>
      </div>
