...
function MessageCard({ isActive }) {
  ...
  const message = `[Miss Suhani shrivastava],

Happy Birthdayyyy cutuuuuu.

You've genuinely helped me so much with everything...,
from listening to me at night to understanding many 
things about me without me even saying them...
Yes, it's true that we've only known each other 
for about two or three months...
but in these two or three months, a unique bond 
has formed that doesn't even develop with people 
I've known for two or three years...
I won't ramble on too much, but at the end of the day, 
I just want you to be with me forever...
Happy Birthday mere sherrrrr! 🎉
